...
export HYDROSAT_TURBIDITY_PRIOR_SHRINK="${HYDROSAT_TURBIDITY_PRIOR_SHRINK:-0}"
...
export HYDROSAT_TURBIDITY_CALIBRATION="${HYDROSAT_TURBIDITY_CALIBRATION:-}"
export HYDROSAT_TURBIDITY_LOGNORMAL_SIGMA="${HYDROSAT_TURBIDITY_LOGNORMAL_SIGMA:-0.55}"
