...
ENV HYDROSAT_TURBIDITY_PRIOR_SHRINK=0.05
ENV HYDROSAT_CHLA_PRIOR_SHRINK=0
ENV HYDROSAT_NEUTRALIZE_GEO=0
ENV HYDROSAT_TURBIDITY_MODE=model
ENV HYDROSAT_TURBIDITY_INVERT_RANK=0
ENV HYDROSAT_TURBIDITY_HEURISTIC_WEIGHT=0.81
ENV HYDROSAT_TURBIDITY_CALIBRATION=lognormal_rank
ENV HYDROSAT_TURBIDITY_LOGNORMAL_SIGMA=0.52
